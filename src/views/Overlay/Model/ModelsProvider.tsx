...
type ContextType = {
  ...
  prepareModelConfig: (config: InterfaceModelConfig, provider: InterfaceProvider) => Promise<InterfaceModelConfig>
...
export default function ModelsProvider({
  ...
  const saveConfig = async (newActiveProvider?: InterfaceProvider) => {
    ...
    //   if (value !== undefined) {
    //     compressedData[key] = await prepareModelConfig(value, value.modelProvider)
    //   }
    // })
